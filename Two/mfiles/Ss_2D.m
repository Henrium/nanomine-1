...
image_ext = zeros([pixel+2 pixel+2]); % expanded image
image_ext(2:pixel+1,2:pixel+1) = image;
image_tmp = 4*image - image_ext(1:pixel,2:pixel+1) - ...
                       image_ext(3:pixel+2,2:pixel+1)...
                    - image_ext(2:pixel+1,1:pixel) - image_ext(2:pixel+1,3:pixel+2);
