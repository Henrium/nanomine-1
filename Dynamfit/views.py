...
def sampleinput(request):
	if request.user.is_authenticated():
		...
		if request.method == 'POST':
			# Link of Apache page
			examplelink2result = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/'
...
def samplerun(request):
	if request.user.is_authenticated():
		Eprime = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/exampleE.jpg'
		EEprime = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/exampleEE.jpg'
		XPR_link = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/EXAMPLE.XPR'
		XFF_link = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/EXAMPLE.XFF'
		XTF_link = 'http://puma.mech.northwestern.edu/nanomine/Dynamfit/EXAMPLE.XTF'
