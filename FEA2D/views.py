...
def validate(request):
		...
		if graft == 'bare':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_BS_1wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_1BAREsilica-min.jpg'
		        STRUCTIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/structure-bare.jpg'
		elif graft == 'monoPGMA':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_PGMA_2wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_2silica_PGMA_4-min.jpg'
		        STRUCTIMGFILE = ''
		elif graft == 'ferroPGMA':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_ferroPGMA_2wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_2ferroPGMAsilica-min.jpg'
		        STRUCTIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/structure-ferro.jpg'
		elif graft == 'terthiophenePGMA':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_terthiophenePGMA_2wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_terthiophene2_005-min.jpg'
		        STRUCTIMGFILE = ''
		elif graft == 'monothiophenePGMA':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_monothiophenePGMA_2wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_monothiophene_3-min.jpg'
		        STRUCTIMGFILE = ''
		elif graft == 'anthraenePGMA':
		        BINIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/crop_anthracenePGMA_2wt.jpg'
		        TEMIMGFILE = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/TEM_anthracene_3-min.jpg'
		        STRUCTIMGFILE = ''
		else:
		        IMGFILE = ''
		        TEMIMGFILE = ''
...
def runmodel(request):
	if request.user.is_authenticated():    
		...
		# Link of Apache page
		link2result = 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/'+timestamp+'_'+str(int(count[0]))
...
def check(request):
		...
		if len(request.POST) != 0: # when there is actual input
		        ...
		        if FINISH ==1 :
		                ...
		                HTTPROOT= 'http://puma.mech.northwestern.edu/nanomine/DielectricFEA2D/'+str(jobID)
