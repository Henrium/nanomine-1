...
def runmodel(request):
    if request.user.is_authenticated():
        ...
        link2result = 'http://puma.mech.northwestern.edu/nanomine/AUTOFIT/'+timestamp+'_'+str(int(count[0]))
        ...
        str_OpenPort1 = '~/comsol52/bin/comsol server -port '+str(PORT)+' &'
        ...
        str_OpenPort2 = '~/comsol52/bin/comsol server -port '+str(PORT+1)+' &'
        str_PATH = "addpath('/home/NANOMINE/comsol52/mli','/home/NANOMINE/comsol52/mli/startup');"
    ...
    if request.user.is_authenticated():
        ...
        if len(request.POST) != 0:
            ...
            if FINISH == 1:		
                ...
                HTTPROOT = 'http://puma.mech.northwestern.edu/nanomine/AUTOFIT/'+str(jobID)
